...
static char *user_extension = NULL;
static void handle_e_option(char* z)
{
  if (!user_extension)
  {
    user_extension = (char *) malloc(1 + lemonStrlen(z));
    if (0 == user_extension)
    {
      memory_error();
    }
    lemon_strcpy(user_extension, z);
  }
}
...
int main(int argc, char **argv)
{
  ...
  static struct s_options options[] = {
    ...
    {OPT_FSTR, "e", (char*) handle_e_option, "Specify output file extension."},
