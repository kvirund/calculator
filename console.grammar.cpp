...
#define YY_MIN_SHIFTREDUCE   14
#define YY_MAX_SHIFTREDUCE   21
#define YY_MIN_REDUCE        22
#define YY_MAX_REDUCE        29
#define YY_ERROR_ACTION      30
#define YY_ACCEPT_ACTION     31
#define YY_NO_ACTION         32
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    18,    1,   15,   21,    4,   31,    6,   16,   17,    2,
 /*    10 */     3,   20,   22,   19,    5,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     4,    5,    2,    7,    8,   10,   11,    2,    3,    1,
 /*    10 */    12,    7,    0,    7,    6,
};
...
static const char *const yyTokenName[] = { 
  "$",             "DOT",           "IDENTIFIER",    "UNDOREDO",    
  "SWITCH",        "SET_COMMAND",   "ASSIGN",        "TAIL",        
  "EXEC_COMMAND",  "error",         "expression",    "expr",        
  "identifier",  
};
#endif /* NDEBUG */
...
static const char *const yyRuleName[] = {
 ...
 /*   3 */ "identifier ::= identifier DOT UNDOREDO",
 /*   4 */ "expr ::= SWITCH",
 /*   5 */ "expr ::= SET_COMMAND identifier ASSIGN TAIL",
 /*   6 */ "expr ::= EXEC_COMMAND TAIL",
 /*   7 */ "expr ::= TAIL",
};
#endif /* NDEBUG */
...
#line 63 "/home/veei/git/calculator/console.grammar.y"
{
    ...
    parser::CObjectTreeNode* var = static_cast<parser::CObjectTreeNode*>(yymsp[-2].minor.yy0);
