/* Generated by re2c 0.13.5 on Thu Dec 25 16:04:22 2014 */
#line 1 "scanner.re"
#include "scanner.h"
...
yy8:
#line 51 "scanner.re"
        { offset += cursor - p_start; return CToken(ET_INTEGER, expression.substr(start, cursor - p_start)); }
#line 151 "scanner.cpp"
yy9:
        yyaccept = 1;
        yych = (unsigned char)*(marker = ++cursor);
        goto yy58;
